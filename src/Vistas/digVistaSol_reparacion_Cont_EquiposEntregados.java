 ...
 */
public class digVistaSol_reparacion_Cont_EquiposEntregados extends javax.swing.JDialog {

    /**
     * Creates new form digVistaClientes
     */
    public digVistaSol_reparacion_Cont_EquiposEntregados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    void mostrar(String buscar) {
        try {
            ...
            modelo = func.mostrarVistaEquipoEntregado(buscar);
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        ...
        if (evt.getClickCount() == 2) {
            ...
            if(estado.equals("Completada la revisión - Equipo  entregado")) {
                frmControlContratos.btnEnviarCorreoElectronico.setEnabled(false);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(digVistaSol_reparacion_Cont_EquiposEntregados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                digVistaSol_reparacion_Cont_EquiposEntregados dialog = new digVistaSol_reparacion_Cont_EquiposEntregados(new javax.swing.JFrame(), true);
