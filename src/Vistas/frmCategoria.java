...
public class frmCategoria extends javax.swing.JFrame {
    ...
    void imprimirReporte() {
        try {
            ...
            Global.generarReporte("rptCategorias",params);
            inhabilitar();
    ...
    void mostrar(String buscar) {
        try {
            ...
            BD_categoria func = new BD_categoria();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Archivos/imagen Menu Categoría/icons8_Category_100px.png"))); // NOI18N
        ...
        txtNombre.setToolTipText("Ingrese el nombre de la categoria");
        ...
        txtId_Categoria.setBackground(new java.awt.Color(51, 153, 255));
        txtId_Categoria.setFont(new java.awt.Font("Tempus Sans ITC", 0, 14)); // NOI18N
        txtId_Categoria.setForeground(new java.awt.Color(255, 255, 255));
        txtId_Categoria.setBorder(null);
        txtId_Categoria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtId_CategoriaActionPerformed(evt);
            }
        });
        panelUser.add(txtId_Categoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 180, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        ca.setNombre_categoria(txtNombre.getText());
        //se crea la clase de conexion a la base de datos
        BD_categoria bd = new BD_categoria();
        ...
        if (accion.equals("guardar")) {
            ...
            ca.setId_categoria(Integer.parseInt(txtId_Categoria.getText()));
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        txtId_Categoria.setText(tablalistado.getValueAt(fila, 0).toString());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        if (!txtId_Categoria.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Estas seguro de Eliminar el La categoria?", "Confirmar", 2);
            if (confirmacion == 0) {
                BD_categoria func = new BD_categoria();
                categoria dts = new categoria();

                dts.setId_categoria(Integer.parseInt(txtId_Categoria.getText()));
                func.eliminar(dts.getId_categoria());
                mostrar("");
                inhabilitar();
            }
        }
