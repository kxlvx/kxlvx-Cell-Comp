 ...
 * @author samux
 */
public class frmProveedorTelefonos extends javax.swing.JFrame {

    /**
     * Creates new form frmClientes
     */
    public frmProveedorTelefonos() {
        initComponents();
    ...
    void mostrar(String buscar) {
        try {
            ...
            BD_Proveedor_Telefonos func = new BD_Proveedor_Telefonos();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Teléfonos de los Proveedores ");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        telefono_proveedor ca = new telefono_proveedor();
        ca.setCod_proveedor(Integer.parseInt(txt_CodProveedor.getText()));
        ca.setTelefono(txtTelefono.getText());
        //se crea la clase de conexion a la base de datos
        BD_Proveedor_Telefonos bd = new BD_Proveedor_Telefonos();
        ...
        if (accion.equals("guardar")) {
            ...
            ca.setCod_telf_prov(Integer.parseInt(txtId_telefono.getText()));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!txt_CodProveedor.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Estas seguro de Eliminar el La categoria?", "Confirmar", 2);
            if (confirmacion == 0) {
                BD_Proveedor_Telefonos func = new BD_Proveedor_Telefonos();
                telefono_proveedor dts = new telefono_proveedor();

                dts.setCod_telf_prov(Integer.parseInt(txtId_telefono.getText()));
                func.eliminar(dts);
                mostrar(txt_CodProveedor.getText());
                inhabilitar();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmProveedorTelefonos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmProveedorTelefonos().setVisible(true);
            }
        });
    }
