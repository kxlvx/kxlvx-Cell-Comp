 ...
 */
public class digVistaSol_reparacion_Cont_EquiposNoesntrgados extends javax.swing.JDialog {

    /**
     * Creates new form digVistaClientes
     */
    public digVistaSol_reparacion_Cont_EquiposNoesntrgados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    void mostrar(String buscar) {
        try {
            ...
            modelo = func.mostrarVistaEquipoNoentregado(buscar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(digVistaSol_reparacion_Cont_EquiposNoesntrgados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                digVistaSol_reparacion_Cont_EquiposNoesntrgados dialog = new digVistaSol_reparacion_Cont_EquiposNoesntrgados(new javax.swing.JFrame(), true);
